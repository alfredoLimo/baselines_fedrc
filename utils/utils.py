...
def get_cifar10C_loaders(root_path, batch_size, is_validation, test=False, test_num = 3, train_num=10):
    train_iterators, val_iterators, test_iterators, client_types, client_features = [], [], [], [], []
    if test:
        for i in range(1, test_num + 1):
            task_data_path = os.path.join(root_path, 'test-{}.pkl'.format(i))
    ...
    for i in range(train_num): # each client?
        task_data_path = os.path.join(root_path, '{}.pkl'.format(i))
        with open(task_data_path, "rb") as f:
            client = pickle.load(f)
        train_indices, val_indices, test_indices = split_train_val_test(len(client['labels']))
    ...
    print(f"type of train_iterators: {type(train_iterators)}")
    print(f"length of train_iterators: {len(train_iterators)}")
    print(f"type of train_iterators[0]: {type(train_iterators[0])}")
    print(f"length of train_iterators[0]: {len(train_iterators[0])}")
    print("\n")

    print(f"type of val_iterators: {type(val_iterators)}")
    print(f"length of val_iterators: {len(val_iterators)}")
    print(f"type of val_iterators[0]: {type(val_iterators[0])}")
    print(f"length of val_iterators[0]: {len(val_iterators[0])}")
    print("\n")

    print(f"type of test_iterators: {type(test_iterators)}")
    print(f"length of test_iterators: {len(test_iterators)}")
    print(f"type of test_iterators[0]: {type(test_iterators[0])}")
    print(f"length of test_iterators[0]: {len(test_iterators[0])}")
    print("\n")


    print(f"type of client_types: {type(client_types)}")
    print(f"length of client_types: {len(client_types)}")
    print(f"type of client_types[0]: {type(client_types[0])}")
    print("\n")

    print(f"type of client_features: {type(client_features)}")
    print(f"length of client_features: {len(client_features)}")
    print(f"type of client_features[0]: {type(client_features[0])}")
    print("\n")
